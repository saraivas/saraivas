...
- 🛠️ Core stack: Python (FastAPI, Flask) · React · PostgreSQL · Azure · Docker
- 📚 Currently deep-diving into distributed systems, system design, and vector search at scale — documenting the process publicly (see pinned repos / blog)
- 📫 Reach me: felipesaraivadossantos@gmail.com · [LinkedIn](https://www.linkedin.com/in/felipe-saraiva-42659720a/)
---
 
### Recent focus areas
- Multi-tenant SaaS architecture & tenant isolation strategies
- Auth systems & security (found and fixed a real cross-tenant cache vulnerability in production)
- AI-powered document extraction & entity resolution pipelines
- System design fundamentals & distributed systems (ongoing, in public)
